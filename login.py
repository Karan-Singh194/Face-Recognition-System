...
# Username Field
empid_label = Label(login_frame, text="User ID :",bg="#CFE4FA", font=('Segoe UI', 11,"bold"))
...
# Password Field
password_label = Label(login_frame, text="Password :", bg="#CFE4FA", font=('Segoe UI', 11,"bold"))
